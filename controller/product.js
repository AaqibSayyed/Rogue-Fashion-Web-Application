...
async function addProductController(req, res) {
    ...
    if (!add_product_check || (add_product_check && add_product_check.error)) {
        return res.status(add_product_check.status).send({ error: add_product_check.error })
    }

    return res.status(add_product_check.status).send({ data: add_product_check.data })
}
...
async function updateProductController(req, res) {
    ...
    if (!update_product_check || (update_product_check && update_product_check.error)) {
        return res.status(update_product_check.status).send({ error: update_product_check.error })
    }
    return res.status(update_product_check.status).send({ data: update_product_check.data })
}
...
async function deleteProductController(req, res) {
    ...
    if (!delete_product_check || (delete_product_check && delete_product_check.error)) {
        return res.status(delete_product_check.status).send({ error: delete_product_check.error })
    }

    return res.status(delete_product_check.status).send({ data: delete_product_check.data })
}
...
async function viewProductController(req, res) {
    ...
    if (!view_product_check || (view_product_check && view_product_check.error)) {
        return res.status(view_product_check.status).send({ error: view_product_check.error })
    }

    return res.status(view_product_check.status).send({ data: view_product_check.data })
}
...
async function restoreProductController(req, res) {
    ...
    if (!restore_product_check || (restore_product_check && restore_product_check.error)) {
        return res.status(restore_product_check.status).send({ error: restore_product_check.error })
    }
    return res.status(restore_product_check.status).send({ data: restore_product_check.data })
}
...
async function activeProductController(req, res) {
    ...
    if (!active_product_check || (active_product_check && active_product_check.error)) {
        return res.status(active_product_check.status).send({ error: active_product_check.error })
    }

    return res.status(active_product_check.status).send({ data: active_product_check.data })
...
async function deactiveProductController(req, res) {
    ...
    if (!deactive_product_check || (deactive_product_check && deactive_product_check.error)) {
        return res.status(deactive_product_check.status).send({ error: deactive_product_check.error })
    }

    return res.status(deactive_product_check.status).send({ data: deactive_product_check.data })
...
async function assignController(req, res) {
    ...
    if (!assign_check || (assign_check && assign_check.error)) {
        return res.status(assign_check.status).send({ error: assign_check.error })
    }
    return res.status(assign_check.status).send({ data: assign_check.data })
}
...
async function viewSingleProductController(req, res) {
    ...
    if (!view_single_product_check || (view_single_product_check && view_single_product_check.error)) {
        return res.status(view_single_product_check.status).send({ error: view_single_product_check.error })
    }

    return res.status(view_single_product_check.status).send({ data: view_single_product_check.data })
}
